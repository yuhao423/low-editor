...
import { Plus, Home, Check,MoreHorizontal } from 'lucide-react';
import {
    DropdownMenu,
    DropdownMenuTrigger,
    DropdownMenuContent,
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-2">
                                    {isMain && (
                                        <Home className={`w-4 h-4 ${isActive ? 'text-[#4352f4]' : 'text-[#97a0f9]'}`} />
                                    )}
                                    {isActive && <Check className="w-4 h-4 text-[#4352f4]" />}
                                    <span
                                        className={`font-medium ${isActive ? 'text-[#4352f4]' : 'text-gray-800'
                                            }`}
                                    >
                                        {page.name}
                                    </span>
